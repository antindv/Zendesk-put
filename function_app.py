...
#===========================================================================
# 4) Perform a GET Query on Zendesk to extrat the list of tickets to change
#===========================================================================
...
def update_ticket(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        # Create variable for LOGS purpose
        ticket_scanned = []
        ticket_updated = []
        count_updated = 0
        ...
        for ticket_id in ticket_ids:
            ...
            # Case that the investor is not present in the table
            if len(merged) == 0:
            ...
            # Case that the investor is present in the table
            else:
                logging.info(f"Investor found for {ticket_id}.")
                # Create the string format of the cell to populate in Zendesk for the PUT with a comma separator
            ...
            if (
                ...
                ticket_updated, count_updated = put_email_IR(ticket_id, investors, coverage, support, USER_EMAIL, API_TOKEN, ticket_updated, count_updated)

        # Finalisation of the code: generation of the Response
        body = {
            "status": "OK",
